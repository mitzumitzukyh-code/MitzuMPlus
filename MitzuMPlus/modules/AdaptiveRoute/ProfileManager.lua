...
local DEFAULTS = {
    ...
    settings  = {
        ...
        -- Los ajustes de flechas (routeArrowsEnabled, arrowSize, arrowAnchor,
        -- arrowOffsetX/Y, arrowAlpha, arrowAnimate) ya no son del core: viven
        -- en MitzuRouteArrowsDB. Quien los tuviera guardados aqui los conserva
        -- en su fichero (la fusion es no destructiva y no se borran datos del
        -- usuario), pero MitzuMPlus ya no los lee ni los escribe.
    },
