...
-- El alias global _G.MitzuMPlusEventBus se RETIRO en la separacion del addon.
-- Nadie lo usaba, y dejaba el bus del core al alcance de cualquier addon: con
-- el se podia emitir un MITZU_PULL_CHANGED falso o borrar todos los manejadores
-- con :Clear(). Los addons de fuera leen el estado por MitzuMPlusAPI, que solo
-- ofrece notificaciones con argumentos saneados.
