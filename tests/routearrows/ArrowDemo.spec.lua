...
local printed = {}
-- Un MitzuMPlus FALSO hace de core (con el EventBus REAL). MitzuRouteArrows no
-- lo ve: lo lee por la API publica REAL y la fachada REAL, como en el juego.
...
-- Core listo: API publica encima del core falso, y el nucleo de MitzuRouteArrows.
...
dofile("MitzuRouteArrows/Modules/RouteArrows.lua")
dofile("MitzuRouteArrows/Modules/PullUnitResolver.lua")
...
local G   = AR.GuidanceEngine
local Pr  = AR.RouteArrowPresenter
...
test("C. demo cannot write MATCH anywhere", function()
    ...
    for _, path in ipairs({ "MitzuRouteArrows/Modules/ArrowDemo.lua",
                            "MitzuRouteArrows/Modules/ArrowDemoTelemetry.lua",
                            "MitzuRouteArrows/Modules/NameplateGenerations.lua" }) do
...
test("production pipeline is not wired to the demo", function()
    for _, path in ipairs({ "MitzuRouteArrows/Modules/GuidanceEngine.lua",
                            "MitzuRouteArrows/Modules/RouteArrowPresenter.lua",
                            "MitzuRouteArrows/Modules/RouteArrows.lua",
                            "MitzuRouteArrows/Modules/LiveEnemyResolver.lua",
                            "MitzuMPlus/modules/RouteProgress.lua" }) do
        local f = assert(io.open(path, "r"))
        local src = f:read("*a")
        f:close()
