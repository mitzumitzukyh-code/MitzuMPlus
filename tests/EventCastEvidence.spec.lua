...
dofile("modules/AdaptiveRoute/CastEvidence.lua")
dofile("modules/AdaptiveRoute/EventCastEvidence.lua")
local CE = _G.MitzuMPlus.AdaptiveRoute.CastEvidence
local ECE = _G.MitzuMPlus.AdaptiveRoute.EventCastEvidence
...
test("G SAME_UNIT does not change cast evidence into identity", function()
    reset()
    _G.MitzuMPlus.AdaptiveRoute.UnitLinkEvidence = { Compare = function() return "SAME_UNIT" end }
