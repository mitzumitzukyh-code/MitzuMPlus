...
Current build: **1.0.0-beta.1** (first public beta). Public file type: **Beta**; it will be promoted to **Release** after live validation across several Mythic+ runs.

## License

MIT. Copyright (c) 2026 Mutzuki Mizt. See [`LICENSE`](../LICENSE). The distributed ZIP includes the same `LICENSE` file.
