-- MitzuMPlus · EventCastEvidence v2.0 · FASE 3E, SOLO DIAGNOSTICO
...
if MitzuMPlus.EventBus then
    ...
    MitzuMPlus.EventBus:On("MITZU_KEY_COMPLETED", limpiar)
    MitzuMPlus.EventBus:On("MITZU_KEY_RESET", limpiar)
end
