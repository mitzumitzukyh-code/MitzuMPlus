-- ═══════════════════════════════════════════════════════════════════════════
-- MitzuMPlus · GuidanceEngine v1  —  DECIDIR, y nada más
--
...
MitzuMPlus.GuidanceEngine = GuidanceEngine
...
GuidanceEngine._forced  = {}   -- [unitToken] = true, solo /emp arrowpulltest
...
-- secreto, y la observabilidad fina sigue en /emp probe.
-- ═════════════════════════════════════════════════════════════════════════
...
function GuidanceEngine:StatusLines()
    ...
    local RP = MitzuMPlus.RouteProgress
    local P  = MitzuMPlus.RouteArrowPresenter
    local RA = MitzuMPlus.AdaptiveRoute and MitzuMPlus.AdaptiveRoute.RouteArrows
