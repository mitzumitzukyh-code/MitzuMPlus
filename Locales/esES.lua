...
local L = LibStub("AceLocale-3.0"):NewLocale("MitzuMPlus_Historial", "esES")
if not L then
    L = LibStub("AceLocale-3.0"):NewLocale("MitzuMPlus_Historial", "esMX")
...
L["CONFIG_RUNS_STORED"]     = "Partidas guardadas:"
L["CONFIG_IN_DATABASE"]     = "%d"
L["CONFIG_RESET_CONFIG"]    = "Restablecer ajustes (conserva partidas)"
L["CONFIG_DELETE_ALL"]      = "Borrar historial de partidas"
