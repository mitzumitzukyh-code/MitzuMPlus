-- ═══════════════════════════════════════════════════════════════════════════
-- MitzuRouteArrows · RouteAlignment (FASE 4)  —  SOLO DIAGNÓSTICO
--
...
-- `/mra arrowdemo on`. `/mra align off` apaga la inferencia, no la
-- observación.
-- ═══════════════════════════════════════════════════════════════════════════
...
if Host.EventBus then
    ...
    Host.EventBus:On("MITZU_KEY_STARTED", cortar, 25)
    Host.EventBus:On("MITZU_KEY_COMPLETED", cortar, 25)
    Host.EventBus:On("MITZU_KEY_RESET", cortar, 25)
end
