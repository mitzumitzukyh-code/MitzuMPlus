-- ═══════════════════════════════════════════════════════════════════════════
-- MitzuRouteArrows · NameplateAnchorProvider v1.0
--
...
-- /mra arrow y hay pruebas que las verifican. Cambiarlas sería romper algo
...
-- Separada de Resolve porque /mra plates quiere saber quién manda aunque el
...
-- Existe para /mra plates, que recorre todas las placas de golpe.
