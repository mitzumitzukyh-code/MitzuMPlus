-- ═══════════════════════════════════════════════════════════════════════════
-- MitzuRouteArrows · RouteArrowPresenter v1  —  traducir decisiones a flechas
--
...
MRA.RouteArrowPresenter = RouteArrowPresenter
...
-- /mra marktarget, y ClearAll se llevaría por delante las del jugador.
...
local function guidance() return MRA.GuidanceEngine end
