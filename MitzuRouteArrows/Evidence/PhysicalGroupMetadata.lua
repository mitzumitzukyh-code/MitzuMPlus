-- ==========================================================================
-- MitzuRouteArrows · PhysicalGroupMetadata v1
--
...
local function dungeonData(dungeonIdx)
    local all = MRA.MDTPhysicalGroupData
...
function PhysicalGroupMetadata:StatusLines(route, pullIndex)
    ...
    lines[#lines + 1] = "source=" .. tostring(MRA.MDTPhysicalGroupDataVersion or "UNAVAILABLE")
